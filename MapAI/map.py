    ...
    def a_star(self, map, start, goal):
        ...
        while len(open_lst) > 0:
            ...
            for c in child:
                ...
                c.g = curr_pos.g + 1
                c.h = ((c.position[0] - goal_node.position[0])**2) + ((c.position[1] - goal_node.position[1])**2)
                c.f = c.g + c.h
...
def main():
    ...
    # print("list of time result: ", time_result)
    # print("list of distance result: ", dis_result)
    # print("Performance Measure: ", pm)
